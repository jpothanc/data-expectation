...
<div class="futures-layout">
	...
	<main class="futures-content">

	{#key activeTab}
		{#if activeTab === 'validation'}
			<ValidationTab initialExchange={initialExchange} productType="future" />
		{:else if activeTab === 'instruments'}
			<InstrumentsTab productType="future" />
		{:else if activeTab === 'rules'}
			<RulesTab productType="future" />
		{/if}
	{/key}
	</main>
</div>
